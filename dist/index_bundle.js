	...
	var Avatar = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(ProfilePic, { imageUrl: this.props.imageUrl }),
	      React.createElement(ProfileName, { name: this.props.name }),
	      React.createElement(ProfileLink, { username: this.props.username })
	    );
	  }
	});
	ReactDOM.render(React.createElement(Avatar, { imageUrl: USER_DATA.image, username: USER_DATA.username, name: USER_DATA.name }), document.getElementById('app'));
